      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold">
            <span className="glow-cyan text-[var(--cyan-accent)]">Bancos</span>
          </h1>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {filtered.map(bank => (
            <div
              key={bank.id}
              className="card-futuristic-static py-4 px-4 group relative overflow-hidden"
            >
              {/* Background glow */}
              <div
              ...
              <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className="w-7 h-7 rounded-lg flex items-center justify-center text-[10px] border border-white/5 text-[var(--text-secondary)] hover:text-[var(--cyan-accent)] hover:border-[var(--cyan-accent)]/30 transition-all"
                  title="Editar"
                >
                  ✎
                </button>
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl text-sm bg-transparent border-b-2 text-[var(--text-primary)] placeholder:text-[var(--text-secondary)]/30 outline-none transition-all border-white/10 focus:border-[var(--cyan-accent)]/40"
                />
              </div>
